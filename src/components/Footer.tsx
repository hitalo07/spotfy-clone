...
export function Footer() {
  return (
    <footer className="bg-zinc-800 border-t fixed z-50 bottom-0 w-full border-zinc-700 px-6 py-4 flex items-center justify-between">
        <div className='flex items-center gap-3'>
          <Image src="/album.jpg" className='w-full' width={56} height={56} alt="Album" />
          <div className='flex flex-col'>
            <strong className='font-normal'>Amanhã</strong>
